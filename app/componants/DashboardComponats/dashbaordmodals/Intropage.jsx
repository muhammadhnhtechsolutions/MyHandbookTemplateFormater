...
import img from "../../../assets/imges/Intro sash.png";
...
const Intropage = ({ onClick }) => {
  ...
  //       setIsWatching(true); // Set isWatching to true to show video
    ...
    <div className="bg-white m-auto w-full md:w-[65%] md:pt-6 h-screen md:h-auto overflow-y-auto flex flex-col justify-center items-center md:rounded-[30px] md:border-[6px] md:border-primary md:py-0 py-2">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 p-2 h-[540px]">
         ...
         url='https://familyhandbook.s3.amazonaws.com/website_videos/Intro+Letter.mp4
'
          width='100%'
          height='100%'
          controls={true}
...

{
  /* <div className="flex justify-center space-y-2 flex-col items-center">
            <iframe src="https://player.vimeo.com/video/960399603?h=fa06b53093" width="740" height="362" frameBorder="0" allow="autoplay; fullscreen; picture-in-picture" allowFullScreen></iframe>
                <button
                  onClick={SaveGetIntro}
                  className="text-lg hover:bg-blue-500 transition duration-300 ease-in-out leading-7 font-medium text-white bg-primary py-2 px-4 rounded w-full"
                >
                  {loadingText ? "Loading..." : "GET STARTED"}
                </button>
