...
import {Faqs,Faqss} from  './Faq'
// import Faqss from  './Faq'
...
import image3 from '../../assets/imges/Rectangle 18.png';
import AOS from 'aos';
...
<h1 className='montserrat text-[28px] font-bold text-primary italic leading-[34px]'>
Dear Pastor,
</h1>
<div className='px-2 md:px-14'>
   <p className="text-sm md:text-base lg:text-lg mb-4">
      ...
      <p className="text-sm md:text-base lg:text-lg mb-4">
        What if you could inspire your members from the pulpit to “consider this message in relation to your Family Mission Statement”?
      </p>
      <button
        type="button"
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 items-center sm:mx-4 md:mx-8 pt-5 h-auto">
    <div className="text-white text-left md:text-center montserrat">
      <h1 className='leading-8 text-[24px] sm:text-[28px] md:text-[32px] font-bold mb-6'>
        FAMILY VISION INITIATIVE FOR CHURCHES
      </h1>
