...
import { sendPdfToServerService } from "@/app/services/FInalizeService";
...
// Family Mamber Svg Component and

    // Map Family Mamber Svg Component start
...
useEffect(()=>{
  ...
  // Family Mamber Two Svg Component start
const [dummayImages,setDummyImages]=useState({
 slideOne:[
    "/images/books/slide-one/Handbook-01.jpg",
    "/images/books/slide-one/Handbook-02.jpg",
    "/images/books/slide-one/Handbook-03.jpg",
    "/images/books/slide-one/Handbook-04.jpg",
    "/images/books/slide-one/Handbook-05.jpg",
    "/images/books/slide-one/Handbook-06.jpg",
    "/images/books/slide-one/Handbook-07.jpg",
    "/images/books/slide-one/Handbook-08.jpg",
    "/images/books/slide-one/Handbook-09.jpg",
    "/images/books/slide-one/Handbook-10.jpg",
  ],
  slideTwo:[
    "/images/books/slide-two/slide-two-01.jpg",
    "/images/books/slide-two/slide-two-02.jpg",
    "/images/books/slide-two/slide-two-03.jpg",
    "/images/books/slide-two/slide-two-04.jpg",
    "/images/books/slide-two/slide-two-05.jpg",
    "/images/books/slide-two/slide-two-06.jpg",
    "/images/books/slide-two/slide-two-07.jpg",
    "/images/books/slide-two/slide-two-08.jpg",
    "/images/books/slide-two/slide-two-09.jpg",
    "/images/books/slide-two/slide-two-10.jpg",
  ],
  slideThree:[
    "/images/books/slide-three/slide-three-01.jpg",
    "/images/books/slide-three/slide-three-02.jpg",
    "/images/books/slide-three/slide-three-03.jpg",
    "/images/books/slide-three/slide-three-04.jpg",
    "/images/books/slide-three/slide-three-05.jpg",
    "/images/books/slide-three/slide-three-06.jpg",
    "/images/books/slide-three/slide-three-07.jpg",
    "/images/books/slide-three/slide-three-08.jpg",
    "/images/books/slide-three/slide-three-09.jpg",
    "/images/books/slide-three/slide-three-10.jpg",
  ],
})
const  [viewImages,setViewImages]= useState([])
    // Family Mamber Two Svg Component start
    // let MapFamilyMamberTwoImageDataSvgs = [];
   
    // if (familyMembers?.book?.family_bios && familyMembers?.status) {
    //   let parentLength = familyMembers?.book?.family_bios?.parent_members?.length ?? 0; 
    //   let childrenLength = familyMembers?.book?.family_bios?.other_members?.length ?? 0;
    //   let totalLength = parentLength + childrenLength;
    //  
    //   if (totalLength > 4) {
    //     let initialSkip = parentLength == 1 ? 3 : 2;
    //     let pages = Math.ceil((childrenLength - initialSkip) / 4)

    //     for (let index = 0; index < pages; index++) {
    //       let skip = initialSkip + (index * 4);
   
    //       MapFamilyMamberTwoImageDataSvgs.push(MapFamilyMamberTwoSvgToDataUrl(
    //         <MapFamilyMamberTwoSvg
    //           familyName={familyName}
    //           familyMembers={familyMembers?.book?.family_bios?.other_members.slice(skip, skip + 4)}
    //         />
    //       ));
    //     }
    //    
    // } 
    // const MapFamilyMamberTwoImageData = MapFamilyMamberTwoImageDataSvgs;
 ...
 const [isStatusChange,setIsStatusChange]= useState(false)
    ...
    try {
      await new Promise(async (resolve) => {
        ...
        if (result?.status) {
          ...
          if (result?.book?.core_values) {
            const datausa = Object.values(result?.book?.core_values).filter(
          ...
          if (result?.book?.family_media_agreements) {
            const data = Object.values(
              result?.book?.family_media_agreements
            ).filter(
              (value) =>
          ...
          //code of conduct svg api start
          if (result?.book?.code_of_conducts) {
            const dataConduct = Object.values(
              result?.book?.code_of_conducts
  ...
  useEffect(() => {
    setViewImages(dummayImages.slideOne)
    setLoading(false)
    SaveCompaletePDF();
...
const [isdisable, setIsDisable] = useState(true)
  ...
  const sendPDFToServer = async (email) => {
    ...
    try {
      ...
      const result = await sendPdfToServerService(file,email)
...
const sendEmailForm=(e)=>{
  ...
  setSendEmailResponse('pdf Sent to your email')
  sendPDFToServer(email)
...
//     formData.append("encoded_images", pdf);
//     const reponse = await axios.post("http://167.114.96.66:5005/webapi/pdfdownload", formData, {
//       headers: {
  ...
  return (
    ...
    <div className="container m-auto p-5 md:pt-12">
        <div className="flex justify-center items-center flex-col md:flex-row md:space-x-10 md:space-y-0 space-y-5">
            ...
            <button type="button"
                onClick={() =>{
                  setViewImages(dummayImages.slideTwo)
                 handleImageClick([], 2)
                 }}
            ...
            <button type="button"
                onClick={() => {
                  setViewImages(dummayImages.slideThree)
                handleImageClick([], 3)
                }}
