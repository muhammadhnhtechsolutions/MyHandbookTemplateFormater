...
// family mamber svg state start
const MapThirdFamilyMamberSvg = ({ familyName, parentsDataPreview, imagecover, familyMembers, isFaimlymember }) => (
  <>

       {familyMembers?.status && familyMembers?.book?.family_bios?.other_members.length + familyMembers?.book?.family_bios?.parent_members.length > 2 &&
          Array(familyMembers?.book?.family_bios?.other_members.length + familyMembers?.book?.family_bios?.parent_members.length >= 3 ? 1 : 1).fill(0).map((chunk, index) => (
  <svg
    id={`_x30_1${index + 1}`}
    // id={`Layer_${index + 1}`}
  ...
  >
    ...
    {familyMembers?.status &&
                  familyMembers?.book?.family_bios?.other_members?.slice(index === 0 ? 0 : 3, index == 0 ? 3 : 6).map((parentspreview, idx) => (
    //         <g key={index} style={{ transform: `translateY(${idx === 0 ? -35 : 340 + (idx == 1 ? 0 : idx * 340)}px)` }} className="member-1 parent">
    // <g>
    //   <defs>
    //     <path
    //       id="SVGID_19_"
    ...
    // <rect x={214.5} y={216.2} className="st15" width={162.9} height={179.7} />
    // <text transform="matrix(1 0 0 1 214.4797 226.7758)">
    //   <tspan x={0} y={0} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
    //     {"Family Role:"}
    //   </tspan>
    //   <tspan x={0} y={13} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    //   { parentspreview.relation !== null  ? parentspreview.relation : parentspreview?.other_relation }
    //   </tspan>
    //   <tspan x={0} y={39} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
    //     {"Lives In:"}
    //   </tspan>
    //   <tspan style={{overflowWrap: "break-word",}} x={0} y={52} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    //   {parentspreview.city}
    //   </tspan>
    //   <tspan x={0} y={78} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
    //     {"Favorite Food:"}
    //   </tspan>
    //   <tspan x={0} y={91} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    //   {parentspreview.favourite_food !== "" ? parentspreview.favourite_food : parentspreview.other_favourite_food}
    //   </tspan>
    //   <tspan x={0} y={117} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
    //     {"Favorite Holiday:"}
    //   </tspan>
    //   <tspan x={0} y={130} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    //   {parentspreview.favourite_holiday !== "" ? parentspreview.favourite_holiday : parentspreview.other_favourite_holiday}
    //   </tspan>
    //   {/* <tspan x={0} y={156} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    //     {"Quo dolore explicabo "}
    //   </tspan> */}
    // </text>
    // <rect x={394.2} y={220.4} className="st15" width={153.9} height={145.2} />
    // <text transform="matrix(1 0 0 1 394.1631 230.9568)">
    //   <tspan x={0} y={0} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
    //     {"Birthday:"}
    //   </tspan>
    //   <tspan x={0} y={13} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    ...
    //     {"Birth Place :"}
    //   </tspan>
    //   <tspan x={0} y={52} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    ...
    //   </tspan>
    //   {/* <tspan x={0} y={104} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    //     {"Greatest Fear: "}
    //   </tspan> */}
    //   {/* <tspan x={0} y={117} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
    ...
    //   </text>
    // </g>
    // <rect x={215.7} y={404.8} className="st15" width={332.3} height={40.4} />
    // <text transform="matrix(1 0 0 1 215.7215 412.1513)">
    // {parentspreview.favourite_quote !== "" ? parentspreview.favourite_quote : parentspreview.other_favourite_quote}
    // </text>
    // </g>
    <g key={index} style={{ transform: `translateY(${idx === 0 ? -35 : 300 + (idx == 1 ? 0 : idx * 300)}px)` }} className="member-1 parent">
    <g>
      <defs>
        <path
          id="SVGID_19_"
    ...
    <g>
      <g>
        ...
        >
          ...
          >
            <span
              className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}
            >
              {"Family Role: "}
            </span>
            <br />
            <span className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
            { parentspreview.relation !== null  ? parentspreview.relation : parentspreview?.other_relation }
            </span>
          </p>
        </foreignObject>
        ...
        >
          ...
          >
                 <span x={0} y={78} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
     {"Favorite Food:"}
   </span>
<br />
   <span x={0} y={91} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
   {parentspreview.favourite_food !== "" ? parentspreview.favourite_food : parentspreview.other_favourite_food}
   </span>
          ...
          >
            ...
            <span
              className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
                   ...
                   <br />
                   <span className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
                   {parentspreview.best_attribute !== "" ? parentspreview.best_attribute:parentspreview.other_best_attribute}
                   </span>
          </p>
        </foreignObject>
        {/* <foreignObject
        ...
        >
          ...
          >
             <span x={0} y={117} className={`${idx%2==0 ? "st9 st13 st16":"textColor"}`}>
       {"Favorite Holiday:"}
     </span>
     <br />
     <span x={0} y={130} className={`${idx%2==0 ?  "textColor" : "st25 st13 st17"}`}>
     {parentspreview.favourite_holiday !== "" ? parentspreview.favourite_holiday : parentspreview.other_favourite_holiday}
     </span>
...
export const MapThirdFamilyMamberSvgToDataUrl = (svgComponent) => {
  const svgString = ReactDOMServer.renderToStaticMarkup(svgComponent);
  const buffer = Buffer.from(svgString);
  return `data:image/svg+xml;base64,${buffer.toString('base64')}`;
};
export default MapThirdFamilyMamberSvg;