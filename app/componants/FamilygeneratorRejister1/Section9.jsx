...
export const Section9 = () => {
  return (
    <div className="py-5 w-full">
      <div className="w-full container mx-auto bg-white justify-center shadow-2xl rounded-md">
        <div>
        ...
        <div className="font-normal py-5 leading-8 text-center text-[22px]">
          <p className="py-4">
            Create Your Family Handbook Access, Customize and download your Family Tools and Use Them. If You Don&apos;t Feel It Was Worth Every Penny...
          </p>
          <p className="py-4">Get A Refund & Keep Everything Free of Charge.</p>
        </div>
        <div className="justify-center pt-10 mx-20">
          <Image src={igpic} alt="Family Handbook Image" className="w-auto h-auto" />
          ...
          <div className="pt-6 text-center">
            <button className="bg-[#36ca37] aniation-shade py-2 text-[25px] px-5 font-bold leading-[25px] text-white">
            ...
            <div className="justify-center text-center">
              <div className="flex justify-center">
                <Image src={sign} alt="Signature" className="w-[250px] h-auto" />
              </div>
              <p className="text-[22px] leading-7 font-medium py-4">
                P.S. Remember, the Family Handbook Generator that comes in with The BEST Money-Back Guarantee In The World.
              </p>
              <p className="text-[22px] leading-7 font-normal py-4">
                Try it, Print it, Implement it, Get results.
              </p>
              <p className="text-[22px] leading-7 font-normal py-4">
                And if you’re not happy for any reason (and I mean ANY reason) - just let me know and we’ll refund you your $67.00.
              </p>
            </div>
          </div>
        </div>
