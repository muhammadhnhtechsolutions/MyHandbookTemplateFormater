...
import { setCropData } from "@/app/Redux/lib/features/product/productSlice";
...
const CropImage = () => {
  ...
  return (
    <>
      <button type="button" className="text-white text-center justify-center" onClick={()=>onUpload()}>
        Upload picture
      </button>
      <input
        ref={inputRef}
...
<X size={20} color="#222020" strokeWidth={3}  />
       ...
       {/* crop end */}
        ...
        <hr />
                  <div className="mt-4 space-x-3 justify-end flex mr-4 flex-wrap " style={{ width: "20%" ,float: "right" }} >
