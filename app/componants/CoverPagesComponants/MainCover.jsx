    ...
    const handleEditorData = async () => {
      try {
        ...
        if (result.status) {
          ...
          dispatch(setFamilyName(result.lastname||lastname_heading));
    ...
    {imgdata && imagecover && (
      <div className="w-24">
        ...
        <foreignObject
                  ...
                  className="st4 st5"
                  height={"250px"}
                  style={{borderWidth:4 , borderStyle:"solid" , borderColor:"#ffffff"}}
                >

<img
    style={{ overflow: "visible", width: "100%", height: "100%", position: "relative" , objectFit:"cover" }}
