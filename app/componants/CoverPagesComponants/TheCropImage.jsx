...
const TheCropImage = ({cropValue, hanleImage,index}) => {
  ...
  const getCropData = () => {
    if (typeof cropper !== "undefined") {
      hanleImage(cropper.getCroppedCanvas().toDataURL(),index)
        ...
        <Dialog as="div" className=" relative z-10 " onClose={handleCancel}>
          ...
          <div className="fixed  inset-0 overflow-y-auto">
            <div className="flex min-h-full items-start mt-10 justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-[90%]  transform overflow-hidden rounded-2xl bg-[#03517e] text-white pb-5 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="div"
                    className="flex gap-x-10 flex-row w-full py-4 pb-1 px-6"
                  >
